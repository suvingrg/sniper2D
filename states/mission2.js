...
sniper2D.mission2.prototype = {
  ...
  mainCreate: function () {
    ...
    this.music.play('', 0, 1, true);
	  ...
	  this.target = this.add.sprite(2072, 154, 'target', 6);
  ...
  mainUpdate: function () {
    ...
    if (this.game.input.keyboard.isDown(Phaser.Keyboard.SPACEBAR)) {
      ...
      if (this.worldScale == 1) {
        ...
        if (this.crosshairX >= 2072 && this.crosshairX <= 2083) {
          this.crosshairX -= 1389;
        }
        console.log(this.crosshairX, this.crosshairY);

        if (this.crosshairX >= 2084 && this.crosshairX <= 2114) {
          this.crosshairX -= 1413;
        }
        console.log(this.crosshairX, this.crosshairY);
        ...
        console.log(this.crosshairX, this.crosshairY);
        if (this.crosshairX >= 2082 && this.crosshairX <= 2095) {
          this.crosshairX -= 1398;
        }
        console.log(this.crosshairX, this.crosshairY);

        if (this.crosshairX >= 2096 && this.crosshairX <= 2104) {
          this.crosshairX -= 1432;
        }
        console.log(this.crosshairX, this.crosshairY);
